...
public class ColletorsDemo {
    public static void main(String[] args) {
        ...
        //summingInt(ToIntFunction) : returns a collector that produce the sum of a Integer - valued func
        ...
        //groupingBy() : is used for grouping objets by some property and storing results in a map instance
